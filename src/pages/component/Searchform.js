    ...
    <form className="w-[50%] ml-32 mt-7">
      ...
      <div className="relative">
        ...
        <input
          type="search"
          id="default-search"
          className="font-seri block w-full p-4 ps-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
